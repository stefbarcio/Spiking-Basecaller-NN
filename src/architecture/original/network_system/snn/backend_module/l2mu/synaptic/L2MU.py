...
from src.architecture.original.signal_encoding.single_pop_encoder import SinglePopEncoderSynaptic
from src.architecture.original.signal_encoding.stacked_pop_encoder import StackedPopEncoderSynaptic
