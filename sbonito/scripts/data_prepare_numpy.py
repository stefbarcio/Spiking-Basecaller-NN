...
try:
    ...
    # If the import fails, set a random seed
    DATA_PREPARE_READ_SHUFFLE = random.randint(0, 10000)  # Using a random seed
    use_fixed_seed = False

print(f"{'Using fixed seed:' if use_fixed_seed else 'Using random seed:'} {DATA_PREPARE_READ_SHUFFLE}")
